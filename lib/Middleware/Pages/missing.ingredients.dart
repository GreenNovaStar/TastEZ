        ...
        itemBuilder: (context, index) {
          return Container(
            child: InkWell(
              ...
              child: ListTile(
                title: Text("${widget.isMissing[index].ingredient}"),
                trailing: IconButton(
              ...
              //   (!widget.isMissing[index].hasInCart ? Text("${widget.isMissing[index].ingredient} missing", ) : Text("${widget.isMissing[index].ingredient}", )) :
